...
class TasksActionTest {
    ...
    public void actDeadline_randomByTime_customTimeDeadline() {
        ...
        assertEquals(expectedOutput, duke.testSut(testCustomInputsCommand), "Deadline custom time inputs fails");
    }
    ...
    public void actDeadline_dateTimeFormat_formattedTimeDeadline() {
        ...
        assertEquals(expectedOutput, duke.testSut(testCustomInputsCommand), "Deadline format time inputs fails");
    }
    ...
    public void actEvent_randomAtTime_customTimeDeadline() {
        ...
        assertEquals(expectedOutput, duke.testSut(testCustomInputsCommand), "Event custom time inputs fails");
    }
    ...
    //        assertEquals(expectedOutput, duke.testSut(testCustomInputsCommand), "Event format time inputs fails");
    //    }
    ...
    //        assertEquals(expectedOutput, duke.testSut(testCustomInputsCommand), "List fails");
    //    }
}